...
arguments: 
  ...
  - valueFrom: /home/ec2-user/evaluation_data
    prefix: -i
        ...
        entry: |
          ...
          def main(args):
            ...
            if container is None:
              ...
              try:
                container = client.containers.run(docker_image, "/score_sc2.sh", detach=True, volumes = volumes, name=args.submissionid, network_disabled=True, stderr=True, mem_limit="10g")
