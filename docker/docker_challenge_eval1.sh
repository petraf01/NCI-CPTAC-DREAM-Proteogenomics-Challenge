...
python $script_dir/docker_challengeScheduled.py --timeQuota 36000000 --threads 2 --canCancel -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications score 9609971 >> $script_dir/log/score.log 2>&1

#--------------------
#Stop submissions
#--------------------
#python $script_dir/docker_challenge.py -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications dockerstop 8720143 >> $script_dir/log/score.log 2>&1
