...
python $script_dir/docker_challengeScheduled.py --timeQuota 14400000 --threads 4 --canCancel -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications score 9609967 >> $script_dir/log/score.log 2>&1
python $script_dir/docker_challengeScheduled.py --timeQuota 14400000 --threads 4 --canCancel -u $SYNAPSE_USER -p $SYNAPSE_PASS --send-messages --notifications score 9609968 >> $script_dir/log/score.log 2>&1
